...
_HIGH_NARRATION_STYLE = """1. 【素材边界】只讲述证据中出现的事实，不添加证据之外的事实。可以在证据基础上合理推断，但用叙述语气自然带过（如“看起来”“多半是”“难道说”），不要写成报告腔。
2. 【玩家视角】站在游戏操作者视角讲述，“我们”指代玩家扮演的主角；主角的调查、行动、发现、决定都从“我们”出发，其他角色用名字或称谓第三人称描述。
3. 【对话取舍】对话不逐句复述：过程性对话压缩为事件与结果；身份揭露、重大反转、能立住角色个性的台词保留直接引语。引用宜短不宜长，爆点台词单独成句。
4. 【点名分层】名字留给推动者、真相揭示者和反应有个人印记的角色；其余并入“众人”“大家”等群体动作，多人传递相同信息时合并。
5. 【句首呼吸】句首优先用场景、事件、情绪带入，避免连续多句以人名开头；人名出现后用代词或称谓承接。
6. 【推进留白】每个叙事单元推进一个核心事件，并交代结果、判断或新疑问；转折靠内容与铺垫，不用套话强调。
7. 【口播节奏】句子短促自然、适合中文口播，每个条目通常一到三句；可用长句蓄力、短句收束，避免通篇碎短句。
8. 【温度】解说人格冷静但有温度，情绪在危险、误会、失去、身份揭露和反转处自然加强；不使用网络热梗，不覆盖角色本人的幽默。
