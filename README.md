...
类型适配层：每个系列/内容品类一份，任务创建时继承，task.json 可覆盖。
...
- 设计文档：`docs/2026/0817-v1.0.0-长视频浓缩工作流.md`
- 物料规范：`docs/2026/0817-v1.0.0-物料规范.md`
- 验收文档：`docs/2026/08{18,19,20}-项目验收文档.md`（第三方评估参考）
- 语音风格筛选 v1.0.1：`docs/2026/0820-v1.0.1-短视频虚拟人语音风格筛选标准.md`
- 解说稿大输入优化 v1.0.1：`docs/2026/0820-v1.0.1-解说稿大输入优化方案.md`
